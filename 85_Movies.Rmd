...
plot(dtm.movie.clust_85, cex = .7, labels = Genre.df$Genre)
```



```{r}
movie.groups_85 = cutree(dtm.movie.clust_85, k=10)
table(movie.groups_85, Genre.df$Genre)
```
...
table(shooby_85$cluster, Genre.df$Genre)
```
```{r}
